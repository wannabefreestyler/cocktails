...
public class IngredientService {
    ...
    @Transactional
    public void addIngredient(Long cocktailId, Ingredient ingredient) throws CocktailNotFoundException, IngredientAlreadyExistException {
        ...
        if (cocktail.getIngredientList().stream().anyMatch(existingIngredient -> existingIngredient.getName().equals(ingredient.getName()))) {
    ...
    @Transactional
    public void deleteIngredient(Long cocktailId, Long ingredientId) throws IngredientNotFoundException, CocktailNotFoundException {
        Cocktail cocktail = cocktailRepository.findById(cocktailId).orElse(null);
        if (cocktail == null)
